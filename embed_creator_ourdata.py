# -*- coding: utf-8 -*-
"""
Created on Mon Jan  5 12:21:15 2026
...
import sys
sys.path.append(r"D:\SynapseCLR\pytorch_synapse")
...
if __name__ == "__main__":
    ...
    manual_args = [
        "--config-yaml-path", r"D:\SynapseCLR\output\checkpoint_random\config", 
        "--nr", "0"
    ]
    primary_args = parser.parse_args(args=manual_args)
